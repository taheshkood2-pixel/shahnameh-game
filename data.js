...
const ENEMIES = [
  ...
  {id:'kondrow',ext:'png',name:{fa:'کندرو',en:'Kondrow'},rarity:'R',hp:75,atk:13,def:8,spd:12,tier:1},
  {id:'kaftar_div',ext:'png',name:{fa:'کفتار دیو',en:'Hyena Demon'},rarity:'N',hp:55,atk:11,def:5,spd:15,tier:1},
  {id:'sheer_div',ext:'png',name:{fa:'شیر ژیان',en:'Fierce Lion'},rarity:'R',hp:120,atk:19,def:12,spd:14,tier:2},
  {id:'warg',ext:'png',name:{fa:'گرگ سیاه',en:'Black Wolf'},rarity:'N',hp:68,atk:15,def:7,spd:18,tier:2},
  ...
  {id:'barman',ext:'png',name:{fa:'بارمان',en:'Barman'},rarity:'R',hp:145,atk:23,def:16,spd:14,tier:3},
  {id:'hooman',ext:'png',name:{fa:'هومان تورانی',en:'Human of Turan'},rarity:'R',hp:165,atk:25,def:18,spd:13,tier:3},
  ...
  {id:'narsi',ext:'png',name:{fa:'نرسی دیو',en:'Narsi Demon'},rarity:'R',hp:185,atk:29,def:20,spd:13,tier:5},
  {id:'div_pashang',ext:'png',name:{fa:'پشنگ دیو',en:'Pashang Demon'},rarity:'R',hp:195,atk:31,def:22,spd:12,tier:5},
  {id:'bulman',ext:'png',name:{fa:'بولمان',en:'Bulman'},rarity:'N',hp:100,atk:20,def:12,spd:14,tier:5},
...
// Expanded ITEMS array — 50 items per category (350 total)
  ...
  {id:'belt_50',type:'belt',rarity:'Epic',name:{fa:'belt 50',en:'Belt 50'},def:39,hp:120,spd:5},  {id:'old_cloth_start',type:'armor',rarity:'Common',name:{fa:'لباس کهنه اولیه',en:'Old Starting Cloth'},def:2,hp:4},
];
